...
public class FVUGUIAutomator {
    public static void main(String[] args) {
        ...
        try {
            ...
            String[] versionsToTry = new String[] {
                "8.5", "8.6", "8.7", "8.4", "1.2", "8.8", "8.9", "8.0", "8.1", "8.2", "8.3", ""
            };
            ...
            for (String version : versionsToTry) {
                ...
                if (new File(expectedFvu).exists() || isNonEmptyErrorLog(errPath)) {
                ...
                try {
                    ...
                    // Suppress individual parameter signature try notes
                }
            ...
            if (!success && !new File(expectedFvu).exists() && !isNonEmptyErrorLog(errPath)) {
    ...
    private static boolean isNonEmptyErrorLog(String errPath) {
